...
const FeatureCard = ({ icon, title, content, index }) => (
	<div
		...
		} feature-card hover:text-white`}
		style={{ backgroundColor: 'hsla(290, 10%, 55%, 0.412)' }}
	>
		<div
		...
		<section id='nosotros' className={layout.section}>
			<div className={layout.sectionInfo}>
				...
				<p className={`${styles.paragraph} max-w-[470px] mt-5`}>
					Somos una empresa originaria de México que domina su campo y comprende
					que nuestra excelencia en calidad, puntualidad en entregas y
					dedicación al servicio al cliente constituyen nuestros mayores
					activos. <br /> <br />
					Convertimos los proyectos de nuestros clientes en auténticas
					realidades, empleando incansables esfuerzos y una sólida creencia en
