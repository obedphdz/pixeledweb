	...
	return (
		<div id='servicios' className={styles.find}>
			...
			<div className={styles.slider_container}>
				...
				>
					<SwiperSlide>
						<Card image={anuncio} make='Anuncios' />
					</SwiperSlide>
					<SwiperSlide>
						<Card image={neon} make='Pantallas LED' />
					</SwiperSlide>
					<SwiperSlide>
						<Card image={rotulacion} make='Rotulacion Vehicolar' />
					</SwiperSlide>
					<SwiperSlide>
						<Card image={señaletica} make='Señaletica' />
					</SwiperSlide>
					<SwiperSlide>
						<Card image={letras} make='Letras 3D' />
					</SwiperSlide>

					<SwiperSlide>
						<Card image={largeFormat} make='Impresión Gran Formato' />
					</SwiperSlide>
					<SwiperSlide>
						<Card image={altaDefinicion} make='Impresión alta definción' />
					</SwiperSlide>
				</Swiper>
			</div>
		</div>
