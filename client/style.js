...
const styles = {
    ...
    heading2Mobile: "font-poppins font-semibold xs:text-[12px] text-[24px] text-gradient xs:leading-[32px] leading-[28px] w-full",
  ...
  export const layout = {
    ...
    sectionMobile: `flex flex-col ${styles.paddingY}`,
